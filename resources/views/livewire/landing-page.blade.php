<div>
                ...
                <div class="w-full px-4">
                    <div class="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                        <h1
                            ...
                            Tempat Persiapan Lomba LKS Secara Gratis!
                        </h1>
                        <p
                            class="mx-auto mb-9 max-w-[600px] text-base font-medium text-white sm:text-lg sm:leading-[1.44]">
                            Platform belajar interaktif untuk persiapan LKS Web Technologies. Akses modul latihan, dan
                            berbagi materi untuk membantu mencapai standar kompetisi nasional dan internasional.
                        </p>
                        <ul class="mb-10 flex flex-wrap items-center justify-center gap-5">
                            <li>
                                <a href="{{ route('login') }}" class="inline-flex items-center justify-center rounded-md bg-white px-7 py-[14px] text-center text-base font-medium text-dark shadow-1 transition duration-300 ease-in-out hover:bg-white/[0.12] hover:text-white">
                                    Belajar Sekarang
                                </a>
                            </li>
                            <li>
                        ...
                        <div>
                            <p class="mb-4 text-center text-base font-medium text-white">
                                Thanks for experience to:
                            <div class="wow fadeInUp flex items-center justify-center gap-4 text-center" data-wow-delay=".3s">
                                <a href="https://kemnaker.go.id" class="text-white/60 duration-300 ease-in-out hover:text-white" target="_blank" title="Kementrian Ketenagakerjaan">
                                    <img src="{{ asset('images/kemnaker.png') }}" class="w-auto h-16" alt="kemnaker logo">
                                </a>
                                
                                <a href="https://pusatprestasinasional.kemdikbud.go.id" class="text-white/60 duration-300 ease-in-out hover:text-white" target="_blank" title="Kemendikbud, Puspresnas, BPTI">
                                    <img src="{{ asset('images/bpti.png') }}" class="w-auto h-20" alt="bpti logo">
                                </a>

                                <a href="https://binus.ac.id" class="text-white/60 duration-300 ease-in-out hover:text-white" target="_blank" title="Binus University">
                                    <img src="{{ asset('images/binus.png') }}" class="w-auto h-20" alt="binus logo">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="w-full px-4">
                            <div class="wow fadeInUp relative z-10 mx-auto max-w-[845px]" data-wow-delay=".25s">
                                <div class="mt-16">
                                    <img src="{{ asset('images/LKS-2023.png') }}" alt="hero" class="mx-auto max-w-full h-auto rounded-t-xl rounded-tr-xl" />
                                </div>
                                <div class="absolute -left-9 bottom-0 z-[-1]">
                                    <svg width="134" height="106" viewBox="0 0 134 106" fill="none"
                                        ...
                                        <circle cx="31" cy="104" r="1.66667"
                                            transform="rotate(-90 31 104)" fill="white" />
                                        ...
                                        <circle cx="103" cy="104" r="1.66667"
                                            transform="rotate(-90 103 104)" fill="white" />
                                        <circle cx="132" cy="104" r="1.66667"
                                            transform="rotate(-90 132 104)" fill="white" />
        ...
        <div class="container">
                ...
                <div class="w-full px-4">
                    <div class="mx-auto mb-12 max-w-[485px] text-center lg:mb-[70px]">
                        ...
                        <p class="text-base text-body-color dark:text-dark-6">
                            Platform yang mendukung pembelajaran, persiapan, dan pengembangan keterampilan Kompetitor.
                        </p>
                    </div>
                </div>
            </div>
            <div class="-mx-4 flex flex-wrap justify-center">
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 flex flex-col justify-center items-center" data-wow-delay=".1s">
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9 text-center">
                            Belajar dengan modul sesuai standar kompetisi.
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 flex flex-col justify-center items-center" data-wow-delay=".1s">
                        <div class="relative z-10 mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] bg-primary">
                            <span class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                            <i class="fa fa-clipboard-check text-white text-xl"></i>
                        </div>
                        <h4 class="mb-3 text-xl font-bold text-dark dark:text-white">
                            Penilaian Mandiri
                        </h4>
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9 text-center">
                            Evaluasi hasil belajar Anda dengan marking mandiri dan tingkatkan performa Anda.
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 flex flex-col justify-center items-center" data-wow-delay=".15s">
                        <div class="relative z-10 mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] bg-primary">
                            <span class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9 text-center">
                            Tanya jawab dan berbagi solusi bersama komunitas.
                        </p>
                    </div>
                </div>
                <div class="w-full px-4 md:w-1/2 lg:w-1/4">
                    <div class="wow fadeInUp group mb-12 flex flex-col justify-center items-center" data-wow-delay=".2s">
                        <div class="relative z-10 mb-10 flex h-[70px] w-[70px] items-center justify-center rounded-[14px] bg-primary">
                            <span class="absolute left-0 top-0 -z-[1] mb-8 flex h-[70px] w-[70px] rotate-[25deg] items-center justify-center rounded-[14px] bg-primary bg-opacity-20 duration-300 group-hover:rotate-45"></span>
                        ...
                        <p class="mb-8 text-body-color dark:text-dark-6 lg:mb-9 text-center">
                            Bagikan modul Anda dan bantu komunitas belajar.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="py-12 dark:bg-dark">
        <div class="container px-4">
            <h2 class="text-center mb-10 text-3xl font-bold text-dark dark:text-white sm:text-4xl md:text-[40px] md:leading-[1.2]">
                Teknologi yang Digunakan
            </h2>
            <div class="-mx-4 flex flex-wrap items-center justify-center gap-8 xl:gap-11">
                <a href="https://graygrids.com/">
                    <img src="{{ asset('images/php-mysql.png') }}" alt="graygrids" class="w-28" />
                </a>
                <a href="https://graygrids.com/">
                    <img src="{{ asset('images/laravel.png') }}" alt="graygrids" class="w-28" />
                </a>
                <a href="https://graygrids.com/">
                    <img src="{{ asset('images/javascript.svg') }}" alt="graygrids" class="w-28" />
                </a>
            </div>
        </div>
    </section>
